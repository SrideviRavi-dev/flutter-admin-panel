...
import 'package:admin/features/shop/screens/product/edit_product/widgets/product_size_widget.dart';
...
class EditProductDesktopScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    controller.selectedSizes.assignAll(product.sizes ?? []);
    return Scaffold(
                        ...
                        JRoundedContainer(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizeSelectorWidget(
                                availableSizes: [
                                  'XS','S','M','L','XL','28','30','32','34','38','40', '42','5', '6','7','8','9', '10'
                                ],
                                selectedSizes: controller.selectedSizes,
                                onSelectionChanged: (newSizes) {
                                  controller.selectedSizes.assignAll(newSizes);
                                },
                              ),
